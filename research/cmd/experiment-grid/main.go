...
func main() {
	output := flag.String("output", "data", "complete dataset directory (contains dataset.json, run-log.txt, and raw/)")
...
func run(opts options) error {
	...
	if opts.pilot && filepath.Clean(opts.output) == filepath.Clean("data") {
